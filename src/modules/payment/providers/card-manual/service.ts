...
class CardManualPaymentService extends AbstractPaymentProvider {
  static identifier = "card-manual";
  ...
  async initiatePayment(input: any): Promise<any> {
    return {
      ...
      data: {
        id: "card_manual_session_" + Date.now(),
        provider_id: "card-manual",
...
export default CardManualPaymentService;
